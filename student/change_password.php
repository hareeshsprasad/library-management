                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                           ...
                           if(isset($_POST['submit1'])){
                               ...
                               $checkPassword=mysqli_query($link,"select * from student_registration where username='$username'");                               
                               ...
                               elseif($newpass!=$confirmpass)
                               {
                                ...
                                <div class="alert alert-danger col-lg-12 col-lg-push-0">
                                   ...
                                   mysqli_query($link,"update student_registration set password='$newpass' where username='$username'");
                               }
                           }
